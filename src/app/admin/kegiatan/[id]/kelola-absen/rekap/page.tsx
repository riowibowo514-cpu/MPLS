    ...
    <>
      ...
      <main className="container" style={{ padding: '2rem 1rem' }}>
        ...
        <div className="card" style={{ padding: '2rem', marginBottom: '2rem' }}>
          ...
          {/* Web View Header */}
          <div className="no-print" style={{ textAlign: 'center', marginBottom: '2rem', borderBottom: '2px solid #e2e8f0', paddingBottom: '1.5rem' }}>
          ...
          <div className="no-print" style={{ display: 'flex', gap: '2rem', marginBottom: '2rem', background: '#f8fafc', padding: '1rem', borderRadius: '8px', justifyContent: 'space-around' }}>
                ...
                {absensiList.map((absen, idx) => {
                  ...
                  return (
                    <tr key={absen.id} style={{ borderBottom: '1px solid #e2e8f0' }}>
                      ...
                      {isOdd ? (
                        <>
                          <td className="ttd-cell" style={{ width: '10%' }}>
                            <span className="ttd-num">{idx + 1}</span>
                            <img className="ttd-img" src={absen.ttd_digital} alt="TTD" />
                          </td>
                          <td className="ttd-cell" style={{ width: '10%' }}></td>
                        </>
                      ) : (
                        <>
                          <td className="ttd-cell" style={{ width: '10%' }}></td>
