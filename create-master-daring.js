...
async function injectMasterTemplate() {
  ...
  const sectionsData = [
    ...
    { nama_section: 'Media Sosial', items: [
      ...
      { pertanyaan: 'Apa media informasi atau media sosial yang anda harapkan untuk mendapatkan berita-berita terbaru mengenai BGTK Provinsi Sumbar?', tipe_jawaban: 'pilihan_ganda', opsi_jawaban: ['__CHECKBOX__', 'Instagram', 'Facebook', 'Youtube', 'Tiktok', 'Website BGTK', 'WhatsApp Group'], max_skor: 0 }
    ]},
