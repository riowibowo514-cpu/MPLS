...
// JSON Template tanpa Konsumsi dan Pelayanan Panitia (Untuk Wayoik)
const PKG_TEMPLATE = {
  "instrumen": {
    "nama": "Instrumen Evaluasi Kepuasan Peserta (Wayoik Batch 5)",
    "deskripsi": "Instrumen evaluasi kepuasan peserta khusus untuk kegiatan PKG Wayoik Batch 5 (Tanpa Akomodasi & Panitia)."
  },
  "sections": [
    {
      ...
      "urutan": 1,
      "items": [
        { "label": "Nama Kegiatan", "tipe_data": "pilihan_ganda", "wajib": true, "opsi": ["Wadah Asyik Olah Ide dan Kompetensi (WAYOIK) Batch 5"] }
      ]
    },
    {
...
async function run() {
  console.log("Membentuk Kegiatan PKG Wayoik...");

  // 1. Insert Kegiatan
  const { data: kegData, error: kegErr } = await supabase
    .from('kegiatan')
    .insert([{
      nama_kegiatan: 'Wadah Asyik Olah Ide dan Kompetensi (WAYOIK) Batch 5',
